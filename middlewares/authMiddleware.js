...
const authMiddleware = async (req, res, next) => {
    try {
        ...
        const decodedToken = await adminFirebase.auth().verifyIdToken(tokenCookie);//verifyIdToken decodifica y valida el token. Si es válido devuelve el token decodificado con información del usuario autenticado
